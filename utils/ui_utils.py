...
def render_ecosystem_sidebar():
    ...
    # We use !important to ensure Streamlit's internal styles are overridden
    st.markdown("""
<style>
    /* Hide default Streamlit sidebar navigation page list */
    [data-testid="stSidebarNav"] {
        display: none !important;
    }
    
    /* Stronger fallback to hide the navigation list */
    section[data-testid="stSidebar"] ul {
        display: none !important;
    }

    /* Hover effects for custom stylish buttons */
...
""", unsafe_allow_html=True)
    ...
    # Note: We keep all HTML tags FLUSH LEFT with the margin to avoid causing 
    # markdown code-block interpretation (even a few spaces will trigger it).
    st.markdown("""
...
""", unsafe_allow_html=True)
    ...
    # Standard Streamlit links are safe from rendering bugs
