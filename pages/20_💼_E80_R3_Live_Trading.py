"""
pages/20_💼_E80_R3_Live_Trading.py
===================================
E80/R3 Blend — LIVE trading cockpit (paper ledger since 2026-07-01, $10,000).

Sections:
  1. Action Panel   — sleeve signals, today's BUY/HOLD/SELL, pending executions
...
st.set_page_config(page_title="E80/R3 Live Trading", page_icon="💼", layout="wide")
